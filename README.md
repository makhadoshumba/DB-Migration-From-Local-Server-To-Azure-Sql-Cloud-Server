...
<img src=".assets/03.png" style="width: 650px; height: 400px;">
...
<img src=".assets/04.png" style="width: 650px; height: 400px;">

<br>
Reviewed my configs:
<img src=".assets/05.png" style="width: 650px; height: 400px;">

<br>
I am deploying now:
<img src=".assets/06.png" style="width: 650px; height: 400px;">

<br>
Closely monitoring deployment to see if everything is deploying correctly:
<img src=".assets/07.png" style="width: 650px; height: 400px;">

<br>
Deployment was a success:
<img src=".assets/08.png" style="width: 650px; height: 400px;">

<br>
I made sure the resources were really deployed: 
<img src=".assets/09.png" style="width: 650px; height: 400px;">
...
<img src=".assets/25.png" style="width: 650px; height: 400px;">

<br>
And here I chose which database I am going to export my database into:
<img src=".assets/26.png" style="width: 650px; height: 400px;">

<br>
Configuring for it to export more than one table:
<img src=".assets/27.png" style="width: 650px; height: 400px;">

<br>
Presented with all my tables in my local server:
<img src=".assets/28.png" style="width: 650px; height: 400px;">

<br>
Select all the the tables
<img src=".assets/29.png" style="width: 650px; height: 400px;">

<br>
Now we are about to start exporting/migrating:
<img src=".assets/30.png" style="width: 650px; height: 400px;">

<br>
Reviewing all my configurations before I begin exporting/migrating:
<img src=".assets/31.png" style="width: 650px; height: 400px;">

<br>
The database was successfully migrated to the Azure SQL server:
<img src=".assets/32.png" style="width: 650px; height: 400px;">
